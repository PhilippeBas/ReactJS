  ...
  return (
    <div className={styles.MemeForm} data-testid="MemeForm">
      <form>
        ...
        <br />
        <label htmlFor="x"><h2 style={{display:'inline'}}>x :</h2></label>
        ...
        <br />
        <input name="underline" id="underline" type="checkbox"  onChange={evt=>{
          props.onMemeChange({...props.meme,underline:evt.target.checked})
        }} />&nbsp;<label htmlFor="underline"><h2 style={{display:'inline'}}>underline</h2></label>&nbsp;<h2 style={{display:'inline'}}>/</h2>&nbsp;<label htmlFor="italic"><h2 style={{display:'inline'}}>italic</h2></label>&nbsp;<input name="italic" id="italic" type="checkbox"  onChange={evt=>{
          props.onMemeChange({...props.meme,italic:evt.target.checked})
        }} />
        <hr />
        <br />
        <Button bgColor="lime" type="submit"> Valider </Button>
        <Button bgColor="red" type="reset"> Annuler </Button>
      </form>
    </div>
  )
};
